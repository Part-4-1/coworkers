...
interface UnsavedChangesModalUIProps {
  contents: ReactNode;
    ...
    <div className="flex w-full flex-col justify-center gap-6 px-[31.5px] pt-6 tablet:px-9">
      ...
      <div className="flex w-full gap-2">
        ...
        <Button
          variant="solid"
          onClick={handleSave}
          className="h-[48px] bg-orange-100 hover:bg-orange-200 tablet:w-[138px]"
        >
          저장하기
        </Button>
      </div>
...
export default UnsavedChangesModalUI;
